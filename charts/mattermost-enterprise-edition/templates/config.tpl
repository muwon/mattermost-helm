{{- define "config.tpl" -}}
{
    ...
    "TeamSettings": {
        ...
        "RestrictCreationToDomains": {{ .Values.global.restrictCreationToDomains | quote }},
        "EnableCustomBrand": {{ .Values.global.enableCustomBrand }},
        "CustomBrandText": {{ .Values.global.customBrandText | quote }},
    ...
    "PasswordSettings": {
        "MinimumLength": {{ .Values.global.minimumPasswordLength }},
        "Lowercase": false,
        "Number": false,
        "Uppercase": false,
        "Symbol": false
    ...
    "FileSettings": {
        ...
        "AmazonS3Region": {{ .Values.minio.defaultBucket.region | quote }},
        "AmazonS3Endpoint": "{{ .Values.minio.defaultBucket.endpoint }}",
        "AmazonS3SSL": false,
    ...
    "EmailSettings": {
        ...
        "EnableSignInWithUsername": {{ .Values.global.enableSignInWithUsername }},
